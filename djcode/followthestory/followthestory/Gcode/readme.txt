...
we have the following kkinds
1. Single spike to indicate interest over some short time
2. Repetitive spikes
3. sustained levels

We are interested in 1 and 2.
Use the relative scaling data for all the years. Find number of peaks in the data. Each peak indicates interest in the news at that period. Find peaks in the period selected by user, if not period selected find peak closest to current date.(select a period around the peak to get articles from).
